  ...
  switch (pathname) {
    ...
    case '/warehouse':
      return {
        ...
        label: 'Склад',
        suggestions: [
          'Які товари на критичному залишку?',
          'Скільки днів покриття по готовій продукції?',
          'Покажи динаміку відвантажень',
          'Які партії спливають найближчим часом?',
        ],
      };
    ...
    case '/finance':
      return {
        ...
        suggestions: [
          ...
          'Яка маржинальність по категоріях?',
          'Покажи структуру витрат',
          'Прогноз cashflow на наступний місяць',
        ],
      };
    ...
    case '/hr':
      return {
        ...
        label: 'HR',
        suggestions: [
          'Хто з співробітників має найгірший sentiment?',
          'Скільки конфліктних дзвінків за тиждень?',
          'В якому відділі найбільше конфліктів?',
          'Покажи тренд задоволеності команди',
        ],
      };
